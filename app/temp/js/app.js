...
var Weather = function () {
  ...
  _createClass(Weather, [{
    ...
    key: 'geocode',
    value: function geocode(coordinates) {
    ...
    key: 'weatherLookup',
    value: function weatherLookup(coordinates) {
      var that = this;
      var weatherApi = '56e678830a6e621a5f38e1b43296e432';
      var weatherUrl = 'https://api.darksky.net/forecast/' + weatherApi + '/' + coordinates.latitude + ',' + coordinates.longitude + '?callback=?';
      _jquery2.default.getJSON(weatherUrl, function (data) {
    ...
    value: function printWeather(data) {
      var printPlaces = {
        current: {
          ...
          unit: [(0, _jquery2.default)('.current-temperature-unit'), (0, _jquery2.default)('.current-low-unit'), (0, _jquery2.default)('.current-high-unit'), (0, _jquery2.default)('.current-feels-like-unit')],
          ...
          feelsLike: (0, _jquery2.default)('.current-feels-like-number'),
          description: (0, _jquery2.default)('.current-description')
        },
        forecast: {
          summary: '.forecast-summary',
          date: '.date-',
          icon: '.forecast-icon-',
          unit: ['.forecast-low-unit-', '.forecast-high-unit-'],
      ...
      function printCurrent() {
        ...
        printPlaces.current.low.html(parseInt(data.daily.data[0].temperatureLow));
        printPlaces.current.high.html(parseInt(data.daily.data[0].temperatureHigh));
        printPlaces.current.feelsLike.html(parseInt(data.currently.apparentTemperature));
      ...
      function printForecast() {
        var forecastSummary = (0, _jquery2.default)('' + printPlaces.forecast.summary);
        ...
        for (day = 1; day < 8; day++) {
          ...
          var forecastUnit = [(0, _jquery2.default)('' + printPlaces.forecast.unit[0] + day), (0, _jquery2.default)('' + printPlaces.forecast.unit[1] + day)];
          ...
          var date = new Date(data.daily.data[day].time * 1000);
          ...
          forecastLow.html(parseInt(data.daily.data[day].temperatureLow));
          forecastHigh.html(parseInt(data.daily.data[day].temperatureHigh));
